...
from telemetry_dispatcher import dispatch_telmetery, finalize_telemetry
...
def main():
    ...
    while True:
        ...
        queue.put([{"type": event_data["eventType"]}])
        ...
        if event_data["eventType"] == "INVOKE":
            ...
            print ("Extension Main: Handle Shutdown Initiation", flush=True)
